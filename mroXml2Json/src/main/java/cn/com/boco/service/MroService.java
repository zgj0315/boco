...
//                    log.info("output:{}", sbOutput.toString());
    ...
    public void xmlgz2Json(String strXmlGz, String strJson) {
        BufferedReader br = null;
        BufferedWriter bw = null;
        try {
            br = new BufferedReader(new InputStreamReader(new GZIPInputStream(new FileInputStream(new File(strXmlGz)))));
            bw = new BufferedWriter(new FileWriter(strJson));
            String strLine = null;
            String[] astrTitle = null;
            String strObject = null;
